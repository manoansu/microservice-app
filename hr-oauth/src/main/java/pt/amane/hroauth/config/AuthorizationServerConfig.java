...
/**
 * EnableAuthorizationServer => essa anotação vai fazer um pre processamento
 * por baixo dos panos configurando o nosso microservico para autorizar os tokens..
 * @author manoansu
 *
 */
@Configuration
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter{
	...
	/**
	 * para configurar vamos ter q sobscrever o metodo de  
	 * AuthorizationServerConfigurerAdapter com botao dto source 
